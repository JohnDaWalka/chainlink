...
contract BurnMintERC20PausableUUPS_burnFrom is BurnMintERC20PausableUUPSSetup {
  address s_mockPool;
  uint256 s_amount;
  ...
  function test_BurnFrom() public {
    ...
    s_burnMintERC20PausableUUPS.burnFrom(STRANGER, amountToBurn);
  ...
  function test_BurnFrom_RevertWhen_CallerDoesNotHaveBurnerRole() public {
    ...
    vm.expectRevert(
      abi.encodeWithSelector(
        IAccessControl.AccessControlUnauthorizedAccount.selector, STRANGER, s_burnMintERC20PausableUUPS.BURNER_ROLE()
      )
    );

    s_burnMintERC20PausableUUPS.burnFrom(STRANGER, s_amount);
  }
