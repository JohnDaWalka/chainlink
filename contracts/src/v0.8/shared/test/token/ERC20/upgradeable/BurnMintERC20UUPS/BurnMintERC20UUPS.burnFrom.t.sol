...
contract BurnMintERC20UUPS_burnFrom is BurnMintERC20UUPSSetup {
  address s_mockPool;
  uint256 s_amount;
  ...
  function test_BurnFrom() public {
    ...
    s_burnMintERC20UUPS.burnFrom(STRANGER, amountToBurn);
  ...
  function test_BurnFrom_RevertWhen_CallerDoesNotHaveBurnerRole() public {
    ...
    s_burnMintERC20UUPS.burnFrom(STRANGER, s_amount);
  }
}
