...
contract BurnMintERC20PausableFreezableTransparent_initialize is BurnMintERC20PausableFreezableTransparentSetup {
  function test_Initialize() public view {
    ...
    assertTrue(
      s_burnMintERC20PausableFreezableTransparent.hasRole(
        s_burnMintERC20PausableFreezableTransparent.DEFAULT_ADMIN_ROLE(), s_defaultAdmin
      )
    );
    assertTrue(
      s_burnMintERC20PausableFreezableTransparent.hasRole(
        s_burnMintERC20PausableFreezableTransparent.PAUSER_ROLE(), s_defaultPauser
      )
    );
    assertTrue(
      s_burnMintERC20PausableFreezableTransparent.hasRole(
        s_burnMintERC20PausableFreezableTransparent.FREEZER_ROLE(), s_defaultFreezer
      )
    );
  }
  ...
  function test_Initialize_RevertWhen_CallIsNotThroughProxy() public {
    BurnMintERC20PausableFreezableTransparent newBurnMintERC20PausableFreezableTransparent =
      new BurnMintERC20PausableFreezableTransparent();
