...
require (
	...
	github.com/smartcontractkit/chainlink-sui v0.0.0-20251021221455-db5fa454fb51
	github.com/smartcontractkit/chainlink-sui/deployment v0.0.0-20251021221455-db5fa454fb51
