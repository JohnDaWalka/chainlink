...
// 	// Deploy & configure new offRamp
// 	// we should still be able to send messages using the old pkgId and there shouldn't be any changes needed
// 	// Assertions: ccip message gets sent using the updated pkgId of offramp
...
// 	// update offramp
// 	t.Run("Update Sui offRamp package - Should Succeed", func(t *testing.T) {
// 		require.NoError(t, err)
...
// 	// Deploy new onRamp, we should still be able to end msg using oldPkgId and router through old onRamp
// 	// update onRamp
// 	// Assertions: ccip message gets sent using the updated pkgId of offramp

// 	t.Run("Update Sui onRamp package - Should Succeed", func(t *testing.T) {
...
// 	// update ccip
// 	t.Run("Update Sui ccip package - Should Succeed", func(t *testing.T) {
// 		latestHead, err := testhelpers.LatestBlock(ctx, e.Env, destChain)
// 		require.NoError(t, err)
