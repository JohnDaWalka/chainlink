...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.9.1-0.20250819034432-c5c3258ae239
...
require (
	...
	github.com/smartcontractkit/chainlink-common/pkg/chipingress v0.0.3 // indirect
