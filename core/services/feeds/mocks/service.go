...
// GetJobProposalByRemoteUUID provides a mock function with given fields: ctx, remoteUUID
func (_m *Service) GetJobProposalByRemoteUUID(ctx context.Context, remoteUUID uuid.UUID) (*feeds.JobProposal, error) {
	ret := _m.Called(ctx, remoteUUID)
...
// Service_GetJobProposalByRemoteUUID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetJobProposalByRemoteUUID'
type Service_GetJobProposalByRemoteUUID_Call struct {
	*mock.Call
}
...
func (_e *Service_Expecter) GetJobProposalByRemoteUUID(ctx interface{}, remoteUUID interface{}) *Service_GetJobProposalByRemoteUUID_Call {
	return &Service_GetJobProposalByRemoteUUID_Call{Call: _e.mock.On("GetJobProposalByRemoteUUID", ctx, remoteUUID)}
}

func (_c *Service_GetJobProposalByRemoteUUID_Call) Run(run func(ctx context.Context, remoteUUID uuid.UUID)) *Service_GetJobProposalByRemoteUUID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Service_GetJobProposalByRemoteUUID_Call) Return(_a0 *feeds.JobProposal, _a1 error) *Service_GetJobProposalByRemoteUUID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Service_GetJobProposalByRemoteUUID_Call) RunAndReturn(run func(context.Context, uuid.UUID) (*feeds.JobProposal, error)) *Service_GetJobProposalByRemoteUUID_Call {
	_c.Call.Return(run)
	return _c
}
...
// TransferJob provides a mock function with given fields: ctx, args
func (_m *Service) TransferJob(ctx context.Context, args *feeds.TransferJobArgs) error {
	ret := _m.Called(ctx, args)

	if len(ret) == 0 {
		panic("no return value specified for TransferJob")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *feeds.TransferJobArgs) error); ok {
		r0 = rf(ctx, args)
	} else {
		r0 = ret.Error(0)
	}
...
// Service_TransferJob_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'TransferJob'
type Service_TransferJob_Call struct {
	*mock.Call
}

// TransferJob is a helper method to define mock.On call
//   - ctx context.Context
//   - args *feeds.TransferJobArgs
func (_e *Service_Expecter) TransferJob(ctx interface{}, args interface{}) *Service_TransferJob_Call {
	return &Service_TransferJob_Call{Call: _e.mock.On("TransferJob", ctx, args)}
}

func (_c *Service_TransferJob_Call) Run(run func(ctx context.Context, args *feeds.TransferJobArgs)) *Service_TransferJob_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*feeds.TransferJobArgs))
	})
	return _c
}

func (_c *Service_TransferJob_Call) Return(_a0 error) *Service_TransferJob_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Service_TransferJob_Call) RunAndReturn(run func(context.Context, *feeds.TransferJobArgs) error) *Service_TransferJob_Call {
	_c.Call.Return(run)
	return _c
}
