...
func newStandardConfigProvider(ctx context.Context, lggr logger.Logger, chain legacyevm.Chain, opts *types.RelayOpts, capRegConfigTracker ocrtypes.ContractConfigTracker) (*configWatcher, error) {
