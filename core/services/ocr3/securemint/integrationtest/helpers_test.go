...
func setupNode(
	...
	config, _ := heavyweight.FullTestDBV2(t, func(c *chainlink.Config, _ *chainlink.Secrets) {
		...
		c.Capabilities.Dispatcher.SupportedVersion = ptr(1)
		c.Capabilities.Dispatcher.ReceiverBufferSize = ptr(10000)

		// [Capabilities.Dispatcher.RateLimit]
		c.Capabilities.Dispatcher.RateLimit.GlobalRPS = ptr(float64(800))
		c.Capabilities.Dispatcher.RateLimit.GlobalBurst = ptr(1000)
		c.Capabilities.Dispatcher.RateLimit.PerSenderRPS = ptr(float64(10))
		c.Capabilities.Dispatcher.RateLimit.PerSenderBurst = ptr(50)
