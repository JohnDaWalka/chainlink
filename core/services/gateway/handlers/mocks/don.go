...
func (_m *DON) SendToNode(ctx context.Context, nodeAddress string, req *jsonrpc.Request) error {
...
func (_c *DON_SendToNode_Call) Run(run func(ctx context.Context, nodeAddress string, req *jsonrpc.Request)) *DON_SendToNode_Call {
...
func (_c *DON_SendToNode_Call) RunAndReturn(run func(context.Context, string, *jsonrpc.Request) error) *DON_SendToNode_Call {
	_c.Call.Return(run)
	return _c
}
