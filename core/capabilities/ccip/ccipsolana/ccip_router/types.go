...
type DestChainConfig struct {
	...
	BillingConfig  ChainBillingConfig
}
...
func (obj DestChainConfig) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	...
	// Serialize `BillingConfig` param:
	err = encoder.Encode(obj.BillingConfig)
	if err != nil {
		return err
	}
	return nil
...
func (obj *DestChainConfig) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	...
	err = decoder.Decode(&obj.BillingConfig)
	if err != nil {
		return err
	}
	return nil
...
type ChainBillingConfig struct {
	IsEnabled                         bool
...
func (obj ChainBillingConfig) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Serialize `IsEnabled` param:
	err = encoder.Encode(obj.IsEnabled)
	if err != nil {
		return err
...
func (obj *ChainBillingConfig) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `IsEnabled`:
	err = decoder.Decode(&obj.IsEnabled)
	if err != nil {
		return err
