...
// SetReportContext sets the "reportContext" parameter.
func (inst *Execute) SetReportContext(reportContext [3][32]uint8) *Execute {
	inst.ReportContext = &reportContext
	return inst
}
...
func (inst *Execute) Validate() error {
	// Check whether all (required) parameters are set:
	{
		...
		if inst.ReportContext == nil {
			return errors.New("ReportContext parameter is not set")
		}
	}
			...
			programBranch.Child(ag_format.Instruction("Execute")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Params[len=2]").ParentFunc(func(paramsBranch ag_treeout.Branches) {
						...
						paramsBranch.Child(ag_format.Param("  ReportContext", *inst.ReportContext))
					})
...
func (obj Execute) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	...
	// Serialize `ReportContext` param:
	err = encoder.Encode(obj.ReportContext)
	if err != nil {
		return err
	}
	return nil
...
func (obj *Execute) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	...
	// Deserialize `ReportContext`:
	err = decoder.Decode(&obj.ReportContext)
	if err != nil {
		return err
	}
	return nil
