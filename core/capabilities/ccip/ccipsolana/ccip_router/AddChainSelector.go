...
// SetOnRampAddress sets the "onRampAddress" parameter.
func (inst *AddChainSelector) SetOnRampAddress(onRampAddress []byte) *AddChainSelector {
	inst.OnRampAddress = &onRampAddress
	return inst
}
...
func (inst *AddChainSelector) Validate() error {
	// Check whether all (required) parameters are set:
	{
		...
		if inst.OnRampAddress == nil {
			return errors.New("OnRampAddress parameter is not set")
		}
	}
			...
			programBranch.Child(ag_format.Instruction("AddChainSelector")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Params[len=2]").ParentFunc(func(paramsBranch ag_treeout.Branches) {
						...
						paramsBranch.Child(ag_format.Param("   OnRampAddress", *inst.OnRampAddress))
					})
...
func NewAddChainSelectorInstruction(
	...
	return NewAddChainSelectorInstructionBuilder().
		...
		SetOnRampAddress(onRampAddress).
