...
var ChainReaderConfig = map[string]any{
	"IsLoopPlugin": true,
	"Modules": map[string]any{
		...
		consts.ContractNameOnRamp: map[string]any{
			"Name": "onramp",
			"Functions": map[string]any{
				consts.MethodNameOnRampGetDynamicConfig: map[string]any{
					"Name": "get_dynamic_config",
				},
				consts.MethodNameOnRampGetStaticConfig: map[string]any{
					"Name": "get_static_config",
				},
				consts.MethodNameOnRampGetDestChainConfig: map[string]any{
				...
				consts.MethodNameGetExpectedNextSequenceNumber: map[string]any{
