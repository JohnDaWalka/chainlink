...
func (m MockRelayer) NewCCIPProvider(ctx context.Context, args commontypes.RelayArgs) (commontypes.CCIPProvider, error) {
	panic("not implemented")
}

func (m MockRelayer) TON() (commontypes.TONService, error) {
	panic("not implemented")
}
