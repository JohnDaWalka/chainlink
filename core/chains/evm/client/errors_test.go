...
func Test_Eth_Errors(t *testing.T) {
	...
	t.Run("IsTerminallyUnderpriced", func(t *testing.T) {
		...
		tests := []errorCase{
			...
			{"virtual machine entered unexpected state. Please contact developers and provide transaction details that caused this error. Error description: Assertion error: Fair pubdata price too high", true, "zkSync"},
