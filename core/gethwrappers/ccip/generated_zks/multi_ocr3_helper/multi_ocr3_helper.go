...
func DeployMultiOCR3Helper(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *generated_zks.Transaction, *MultiOCR3Helper, error) {
