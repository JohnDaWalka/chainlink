...
func DeployMockV3Aggregator(auth *bind.TransactOpts, backend bind.ContractBackend, _decimals uint8, _initialAnswer *big.Int) (common.Address, *generated_zks.Transaction, *MockV3Aggregator, error) {
