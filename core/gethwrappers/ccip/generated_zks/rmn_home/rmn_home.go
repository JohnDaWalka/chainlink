...
func DeployRMNHome(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *generated_zks.Transaction, *RMNHome, error) {
	...
	return address, &generated_zks.Transaction{Transaction: tx, Hash_zks: tx.Hash()}, &RMNHome{address: address, abi: *parsed, RMNHomeCaller: RMNHomeCaller{contract: contract}, RMNHomeTransactor: RMNHomeTransactor{contract: contract}, RMNHomeFilterer: RMNHomeFilterer{contract: contract}}, nil
}
