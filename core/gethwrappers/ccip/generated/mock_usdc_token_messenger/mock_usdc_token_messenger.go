...
func DeployMockE2EUSDCTokenMessengerZK(auth *bind.TransactOpts, backend bind.ContractBackend, version uint32, transmitter common.
	Address) (common.
	Address, *generated.
	Transaction, *MockE2EUSDCTokenMessenger, error) {
	parsed,
		err := MockE2EUSDCTokenMessengerMetaData.GetAbi()
	if err != nil {
	...
	address, ethTx,
		contract, err := generated.DeployContract(auth, parsed, common.FromHex(MockE2EUSDCTokenMessengerZKBin), backend,
		version, transmitter,
	)
	if err != nil {
		return common.
	...
	return address,
		ethTx, &MockE2EUSDCTokenMessenger{address: address, abi: *parsed, MockE2EUSDCTokenMessengerCaller: MockE2EUSDCTokenMessengerCaller{contract: contract}, MockE2EUSDCTokenMessengerTransactor: MockE2EUSDCTokenMessengerTransactor{contract: contract}, MockE2EUSDCTokenMessengerFilterer: MockE2EUSDCTokenMessengerFilterer{contract: contract}}, nil
}
