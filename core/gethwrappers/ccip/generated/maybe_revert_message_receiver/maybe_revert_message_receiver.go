...
func DeployMaybeRevertMessageReceiverZK(auth *bind.TransactOpts, backend bind.ContractBackend, toRevert bool) (common.Address, *generated.
	Transaction, *MaybeRevertMessageReceiver,
	...
	address, ethTx, contract, err := generated.
		DeployContract(auth, parsed, common.FromHex(MaybeRevertMessageReceiverZKBin), backend,
			toRevert,
		)
	if err != nil {
		return common.Address{}, nil, nil, err
	...
	return address,
		ethTx, &MaybeRevertMessageReceiver{address: address, abi: *parsed,
			MaybeRevertMessageReceiverCaller: MaybeRevertMessageReceiverCaller{contract: contract}, MaybeRevertMessageReceiverTransactor: MaybeRevertMessageReceiverTransactor{contract: contract}, MaybeRevertMessageReceiverFilterer: MaybeRevertMessageReceiverFilterer{contract: contract}}, nil
}
