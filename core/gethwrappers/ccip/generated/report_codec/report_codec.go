...
func DeployReportCodecZK(auth *bind.TransactOpts, backend bind.ContractBackend) (common.
	...
	*ReportCodec, error) {
	...
	address, ethTx, contract, err := generated.
		DeployContract(auth, parsed, common.FromHex(ReportCodecZKBin), backend)
	if err != nil {
		return common.Address{},
			nil, nil, err
	}
	return address,
		ethTx, &ReportCodec{address: address, abi: *parsed, ReportCodecCaller: ReportCodecCaller{contract: contract}, ReportCodecTransactor: ReportCodecTransactor{contract: contract}, ReportCodecFilterer: ReportCodecFilterer{contract: contract}}, nil
}
