...
var USDCReaderTesterZKBin = ("")

func DeployUSDCReaderTesterZK(auth *bind.TransactOpts, backend bind.ContractBackend) (common.
	Address, *generated.Transaction,

	*USDCReaderTester, error) {
	parsed, err := USDCReaderTesterMetaData.GetAbi()
	if err !=
		nil {
	...
	address, ethTx, contract, err :=
		generated.DeployContract(auth, parsed, common.
			FromHex(USDCReaderTesterZKBin), backend)
	if err != nil {
		return common.
				Address{}, nil,
			nil, err
	...
	return address, ethTx,
		&USDCReaderTester{address: address,
			abi: *parsed, USDCReaderTesterCaller: USDCReaderTesterCaller{contract: contract}, USDCReaderTesterTransactor: USDCReaderTesterTransactor{contract: contract}, USDCReaderTesterFilterer: USDCReaderTesterFilterer{contract: contract}}, nil
}
