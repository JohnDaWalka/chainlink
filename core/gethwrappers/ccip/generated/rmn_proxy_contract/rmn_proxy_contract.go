...
func DeployRMNProxyContractZK(auth *bind.TransactOpts, backend bind.ContractBackend, params string) (common.Address, *generated.
	Transaction,
	...
	*RMNProxyContract,
	...
	error) {
	parsed,
		err := RMNProxyContractMetaData.GetAbi()
	if err != nil {
	...
	address, ethTx, contract, err := generated.DeployContract(auth, parsed,
		common.FromHex(RMNProxyContractZKBin), backend, params)
	if err != nil {

		return common.Address{}, nil, nil, err
	}
	return address,
		ethTx, &RMNProxyContract{address: address,
			abi:                    *parsed,
			RMNProxyContractCaller: RMNProxyContractCaller{contract: contract}, RMNProxyContractTransactor: RMNProxyContractTransactor{contract: contract}, RMNProxyContractFilterer: RMNProxyContractFilterer{contract: contract}}, nil
}
