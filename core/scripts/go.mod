...
require (
	...
	github.com/smartcontractkit/chain-selectors v1.0.48-0.20250528190305-540dc44d86f2 // indirect
	github.com/smartcontractkit/chainlink-ccip v0.0.0-20250528202527-d6c62525c8dc // indirect
