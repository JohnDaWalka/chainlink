...
require (
	...
	github.com/smartcontractkit/chain-selectors v1.0.54 // indirect
	...
	github.com/smartcontractkit/chainlink-testing-framework/framework v0.7.8-0.20250506172013-5b2c9eb9ee71 // indirect
