...
2. **AWS SSO access to SDLC**
  ...
  - REQUIRED: environment variable AWS_ECR set to ECR repo
3. **gh cli**
  - To pull the `cre` cli
   ...
   [The ECR repos](https://smartcontract-it.atlassian.net/wiki/spaces/INFRA/pages/1045594280/ECR+image+caching#Environment-specific-Base-Domain)
