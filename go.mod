...
require (
	...
	github.com/smartcontractkit/chainlink-sui v0.0.0-20250902001227-f841bea6fa46
...
require (
	...
	github.com/smartcontractkit/chainlink-deployments-framework v0.31.1-0.20250822085500-af4aee833c2b // indirect
