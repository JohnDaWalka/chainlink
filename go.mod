...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.7.1-0.20250416094658-8b0cb0e0b714
...
require (
	...
	github.com/smartcontractkit/chainlink-common/pkg/monitoring v0.0.0-20250415235644-8703639403c7 // indirect
