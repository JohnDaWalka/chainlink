...
func (c AptosChainUpdate) GetAptosTokenAndTokenPool(state changeset.AptosCCIPChainState) (token aptos.AccountAddress, tokenPoolAddress aptos.AccountAddress, err error) {
