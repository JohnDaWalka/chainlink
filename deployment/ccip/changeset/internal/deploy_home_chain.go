...
func BuildOCR3ConfigForCCIPHome(
	...
	for _, node := range nodes {
		...
		fmt.Println("TRANSMITTT ACCOUNT SUI: ", transmitAccount)
...
func replaceAptosPublicKeys(transmitterKey ocrtypes.Account) ocrtypes.Account {
	...
	if pubkey, ok := map[ocrtypes.Account]ocrtypes.Account{
		// address -> pubkey
		"f2925ff6010bb19dfb46a0836411f6a7c8673773352afd9d6b073bea0e5240c1": "3e6cc86cb67d8274d8a64b30cea5f5c875b5ed049b71e2e1a0ab1c69a3a465f4",
		"f3a6ea34ae619e26fa15094a3e675fe4efda568b5d3ef47e237eff8b12518e7d": "38f3f548e834241f321089ce5cf700506ea57e2bebf1546abf04cd7107cc0c93",
		"8ad6cf945fa7f0359d637a2d56f2fd8c6bf67724f3ea39d029b7edfcbf2beaa2": "b41297331d5aa40a7d5d6647b3ff4cea1aa9383435ebe6dfac1d11dd8be9660f",
		"8dbaf7e461afb87f75c6678858dfa9d5393fdc75f0337d43ff52cd14171dac46": "82f86c859fdf035f26f7e26544a64aebdb033777bcd83ad9cde4884cb7382be3",
	}[transmitterKey]; ok {
		return pubkey
	}
