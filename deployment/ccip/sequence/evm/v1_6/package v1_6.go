...
type DeployFeeQInputSui struct {
	Chain         uint64
...
var (
	...
	DeploySuiSupportedFeeQuoterOp = opsutil.NewEVMDeployOperation(
		...
		opsutil.VMDeployers[DeployFeeQInputSui]{
			DeployEVM: func(opts *bind.TransactOpts, backend bind.ContractBackend, input DeployFeeQInputSui) (common.Address, *types.Transaction, error) {
			...
			DeployZksyncVM: func(opts *accounts.TransactOpts, client *clients.Client, wallet *accounts.Wallet, backend bind.ContractBackend, input DeployFeeQInputSui) (common.Address, error) {
