...
var (
	...
	BurnMintWithLockReleaseFlagTokenPool            deployment.ContractType = "BurnMintWithLockReleaseFlagTokenPool"
	SiloedLockReleaseTokenPool                      deployment.ContractType = "SiloedLockReleaseTokenPool"
