...
func LoadOnchainStateSolana(e deployment.Environment) (MCMSSolanaState, error) {
	return MCMSSolanaState{}, fmt.Errorf("unimplemented")
}
...
func GetMCMConfigSignersPDA(programID solana.PublicKey, msigID PDASeed) solana.PublicKey {
